...
function touch_up(x1, y1, x, y) {
	return (inside(x1, y1, x, y + 50) && (Math.abs(x1 + 50 - x) >= 10)) || (inside(x1, y1, x + 50, y + 50) && (Math.abs(x + 50 - x1) >= 10));
}

function touch(A, B) {
	return inside(B.x, B.y, A.x, A.y) || inside(B.x, B.y, A.x + 49.999999, A.y) || inside(B.x, B.y, A.x, A.y + 49.999999) || inside(B.x, B.y, A.x + 49.999999, A.y + 49.999999);
}

function touch1(A, B) {
	return inside(B.x - trai, B.y, A.x, A.y) || inside(B.x - trai, B.y, A.x + 49.999999, A.y) || inside(B.x - trai, B.y, A.x, A.y + 49.999999) || inside(B.x - trai, B.y, A.x + 49.999999, A.y + 49.999999);
}
